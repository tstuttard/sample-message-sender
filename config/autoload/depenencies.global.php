...
return [
    ...
    'dependencies' => [
        ...
        'factories' => [
            ...
            \Zend\Expressive\Template\TemplateRendererInterface::class => PlatesRendererFactory::class,

            Zend\Stratigility\Middleware\ErrorHandler::class => Container\ErrorHandlerFactory::class,
            Middleware\ErrorResponseGenerator::class => Zend\Expressive\Container\WhoopsErrorResponseGeneratorFactory::class,
